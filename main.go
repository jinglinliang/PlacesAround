...
const (
	...
	ES_URL = "http://104.154.182.115:9200"

	BUCKET_NAME = "project_placesaround_image"
)
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("/Users/jinglin/Downloads/PlacesAround-71dadd2e5ea7.json"))
	if err != nil {
		return nil, err
	}
